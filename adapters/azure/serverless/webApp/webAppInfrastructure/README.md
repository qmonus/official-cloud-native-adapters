...
* Import path `qmonus.net/adapter/official/adapters/azure/serverless/webApp/webAppInfrastructure`
...
```yaml
designPatterns:
  - pattern: qmonus.net/adapter/official/adapters/azure/serverless/webApp/webAppInfrastructure
    params:
