...
| containerRegistry  | string | yes | - | コピー先のコンテナレジストリの完全修飾名。コンテナレジストリのログインサーバを指定してください。 | ${acr_name}.azurecr.io　| no |
