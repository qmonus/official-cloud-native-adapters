...
``` yaml
designPatterns:
  - pattern: qmonus.net/adapter/official/pipeline/deploy:simpleSetup # simpleSetupをともに宣言することで、Qmonus Value Streamで段階的なデプロイを行うことができるPipeline/Taskを生成する
    pipelineParams:
      repositoryKind: github
      resourcePriority: high
  - pattern: qmonus.net/adapter/official/pipeline/deploy:simpleApp 
    pipelineParams:
      repositoryKind: github
      resourcePriority: high
```
...
## Code
[deploy:simpleDeploy](../../pipeline/deploy/simpleDeploy.cue)
